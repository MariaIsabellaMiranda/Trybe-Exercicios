...
console.log(`Losângulo de diagonal maior 32cm e diagonal menor 18cm: ${Exercise.losangle(32, 18)}cm²`);
console.log(`Losângulo de diagonal maior 200cm e diagonal menor 50cm: ${Exercise.losangle(200, 50)}cm²`);
console.log(`Losângulo de diagonal maior 75cm e diagonal menor 25cm: ${Exercise.losangle(75, 25)}cm²`);
